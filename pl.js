...
module.exports = {
  title: 'Użycie komendy',
  titleError: 'Błąd :warning:',
  titleComp: 'Gotowe :white_check_mark:',
  unknownChannel: 'Nieznany kanał.',
  unknownRole: 'Nieznana rola.',
  unknownMessage: 'Nieznana wiadomość.',
  unknownEmoji: 'Nieznane emoji.',
  premium: 'Ta funkcja jest dostępna tylko dla [donatorów](https://zira.pw/premium).',
  noChannel: ['Najpierw ustaw kanał, używając **', 'channel**.'],
  noMessage: ['Najpierw ustaw wiadomość, której bot powinien użyć, używając **', 'message**.'],
  help: {
    commandsTitle: 'Komendy',
    commands: {
      channel: 'ustawia kanał, którego chcesz używać\n',
      message: 'ustawia wiadomość, której chcesz używać\n',
      add: 'dodaje emoji powiązane z rolą\n',
      toggle: 'dodaje rolę, która może być \n',
      remove: 'remove a role that has been set\n',
      edit: 'edytuje wiadomość wysłaną przez Zirę\n',
      list: 'pokazuje listę używanych ról\n',
      autorole: 'give users and bots a role on join\n',
      log: 'zapisuje, gdy Zira daje lub zabiera role\n',
      join: 'wysyła wiadomość przy wejściu użytkownika\n',
      leave: 'wysyła wiadomość po wyjściu użytkownika\n',
      lang: 'ustawia język\n',
      reset: 'resetuje konfigurację serwera\n',
      info: 'informacje na temat Ziry\n',
      faq: 'frequently asked questions\n',
      ping: 'ping Ziry\n',
      invite: 'zaproś Zirę na swój serwer\n',
      suggestion: '\n',
      submit: 'wysyła sugestię\n',
      ...
      calc: 'kalkulator\n',
      purge: 'usuwa maksymalnie 100 wiadomości\n',
      config: 'pokazuje konfigurację serwera\n',
      prefix: 'zmienia prefiks Ziry na tym serwerze\n',
    },
    categories: {
      role: 'Role',
      logs: 'Zapisywanie zdarzeń',
      suggestion: 'Sugestie',
      misc: 'Różne',
    },
    linksTitle: 'Łącza',
    links: '[Poradnik konfiguracji Ziry](https://demo.zira.pw)\n[Serwer wsparcia](https://zira.pw/support)\n[Panel Ziry](https://zira.pw)\n[Zdobądź Premium](https://zira.pw/premium)\n[Przetłumacz Zirę](https://github.com/HazedSPaCEx/Zira-Translations)',
    news: 'News',
  },
  prefix: {
