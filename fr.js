...
module.exports = {
  ...
  config: {
    ...
    setChannel: 'Configurez un salon en utilisant',
    currentMessage: 'Message Actuel:',
    setMessage: 'Configurez un message en utilisant',
    roles: 'Nombre de rôles configurés:',
    rolesView: ' - visionnez les en utilisant ',
    rolesSet: 'Ajoutez des rôles en utilisant',
    logging: 'Logs',
    join: 'Message de bienvenue',
    leave: 'Message d\'aurevoir',
